...
import net.majorkernelpanic.streaming.fix.NameValuePair;
import net.majorkernelpanic.streaming.fix.URLEncodedUtils;
	...
	public static Session parse(String uri) throws IllegalStateException, IOException
	{
		...
		if (params.size() > 0)
		{
			...
			for (Iterator<NameValuePair> it = params.iterator(); it.hasNext(); )
			{
				...
				{
					builder.setFlashEnabled(param.getValue().equalsIgnoreCase("on"));
				}
